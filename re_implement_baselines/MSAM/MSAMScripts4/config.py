...
DATA_TYPE = "mimic4_icd9" #or "top50" or "clean"
M = 4
SELECTION_CRITERION = "MDP" #or 'MDP' or 'rand'

FILE_NAME = "mimic4_icd9"
...
SAVE_METRICS_PATH = "../models/{}/{}/metrics".format(DATA_TYPE,FILE_NAME)
SAVE_PREDICTION_PATH = "../models/{}/{}/predictions".format(DATA_TYPE,FILE_NAME)
OUTPUT_DIR= "../models/{}/{}/model".format(DATA_TYPE,FILE_NAME)